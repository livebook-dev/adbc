...
static int arrow_array_to_nif_term(ErlNifEnv *env, struct ArrowSchema *schema,
                                   struct ArrowArray *values, int64_t offset,
                                   int64_t count, int64_t level,
                                   std::vector<ERL_NIF_TERM> &out_terms,
                                   ERL_NIF_TERM &value_type,
                                   ERL_NIF_TERM &metadata, ERL_NIF_TERM &error,
                                   bool skip_dictionary_check, void *resource);
static int get_arrow_struct(ErlNifEnv *env, struct ArrowSchema *schema,
                            struct ArrowArray *values, uint64_t level,
                            std::vector<ERL_NIF_TERM> &children,
                            ERL_NIF_TERM &error, void *resource);
static int get_arrow_struct(ErlNifEnv *env, struct ArrowSchema *schema,
                            struct ArrowArray *values, int64_t offset,
                            int64_t count, uint64_t level,
                            std::vector<ERL_NIF_TERM> &children,
                            ERL_NIF_TERM &error, void *resource);
static ERL_NIF_TERM get_arrow_array_map_children(ErlNifEnv *env,
                                                 struct ArrowSchema *schema,
                                                 struct ArrowArray *values,
                                                 uint64_t level,
                                                 void *resource);
static ERL_NIF_TERM
get_arrow_array_map_children(ErlNifEnv *env, struct ArrowSchema *schema,
                             struct ArrowArray *values, int64_t offset,
                             int64_t count, uint64_t level, void *resource);
static ERL_NIF_TERM get_arrow_array_list_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
    uint64_t level, ArrowType list_type, unsigned n_items, void *resource);
static ERL_NIF_TERM get_arrow_array_list_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
    int64_t offset, int64_t count, uint64_t level, ArrowType list_type,
    unsigned n_items, void *resource);
static ERL_NIF_TERM
get_arrow_array_dense_union_children(ErlNifEnv *env, struct ArrowSchema *schema,
                                     struct ArrowArray *values, uint64_t level,
                                     void *resource);
static ERL_NIF_TERM get_arrow_array_dense_union_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
    int64_t offset, int64_t count, uint64_t level, void *resource);
static ERL_NIF_TERM get_arrow_array_sparse_union_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
...
static ERL_NIF_TERM
string_views_from_buffer(ErlNifEnv *env, int64_t element_offset,
                         int64_t element_count, const uint8_t *validity_bitmap,
                         const uint8_t *views_buffer, int64_t n_data_buffers,
...
int get_arrow_struct(ErlNifEnv *env, struct ArrowSchema *schema,
  ...
  for (int64_t child_i = 0; child_i < values->n_children; child_i++) {
    ...
    if (arrow_array_to_nif_term(env, child_schema, child_values, offset, count,
                                level + 1, childrens, child_type,
                                child_metadata, error, false, resource) == 1) {
      return 1;
    }
...
int get_arrow_struct(ErlNifEnv *env, struct ArrowSchema *schema,
                     struct ArrowArray *values, uint64_t level,
                     std::vector<ERL_NIF_TERM> &children, ERL_NIF_TERM &error,
                     void *resource) {
  return get_arrow_struct(env, schema, values, 0, -1, level, children, error,
                          resource);
}

int get_arrow_dictionary(ErlNifEnv *env, struct ArrowSchema *index_schema,
                         struct ArrowArray *index_array,
                         struct ArrowSchema *value_schema,
                         struct ArrowArray *value_array, int64_t offset,
                         int64_t count, uint64_t level,
                         std::vector<ERL_NIF_TERM> &children,
                         ERL_NIF_TERM &error, void *resource) {
  ...
  if (arrow_array_to_nif_term(env, index_schema, index_array, offset, count,
                              level + 1, keys, index_type, index_metadata,
                              error, true, resource) == 1) {
    return 1;
  }
  if (arrow_array_to_nif_term(env, value_schema, value_array, offset, count,
                              level + 1, values, value_type, value_metadata,
...
int get_arrow_dictionary(ErlNifEnv *env, struct ArrowSchema *index_schema,
                         struct ArrowArray *index_array,
                         struct ArrowSchema *value_schema,
                         struct ArrowArray *value_array, uint64_t level,
                         std::vector<ERL_NIF_TERM> &children,
                         ERL_NIF_TERM &error, void *resource) {
  return get_arrow_dictionary(env, index_schema, index_array, value_schema,
                              value_array, 0, -1, level, children, error,
                              resource);
}

ERL_NIF_TERM get_arrow_array_map_children(ErlNifEnv *env,
                                          struct ArrowSchema *schema,
                                          struct ArrowArray *values,
  ...
  if (strcmp("key", entries_schema->children[0]->name) == 0 &&
      strcmp("value", entries_schema->children[1]->name) == 0) {
  ...
  } else if (strcmp("key", entries_schema->children[1]->name) == 0 &&
             strcmp("value", entries_schema->children[0]->name) == 0) {
  ...
  ERL_NIF_TERM map_values[] = {
      ...
      make_adbc_column(env, value_schema, value_values, nif_values[0],
                       value_type, value_metadata, nif_values[1])};

  enif_make_map_from_arrays(env, map_keys, map_values,
                            (unsigned)(sizeof(map_keys) / sizeof(map_keys[0])),
                            &map_out);
  return map_out;
}
...
ERL_NIF_TERM get_arrow_array_dense_union_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
    int64_t offset, int64_t count, uint64_t level, void *resource) {
  ERL_NIF_TERM error{};
  if (schema->n_children > 0 && schema->children == nullptr) {
  ...
  const uint8_t *types_buffer =
      (const uint8_t *)values->buffers[types_buffer_index];
  ...
  for (int64_t child_i = offset; child_i < offset + count; child_i++) {
    ...
    if (arrow_array_to_nif_term(env, field_schema, field_array, child_offset, 1,
                                level + 1, field_values, field_type,
                                field_metadata, error, false, resource) == 1) {
      return error;
    }
  ...
  return enif_make_list_from_array(env, elements.data(),
                                   (unsigned)elements.size());
}

ERL_NIF_TERM get_arrow_array_dense_union_children(ErlNifEnv *env,
                                                  struct ArrowSchema *schema,
                                                  struct ArrowArray *values,
                                                  uint64_t level,
                                                  void *resource) {
...
ERL_NIF_TERM get_arrow_array_sparse_union_children(
    ErlNifEnv *env, struct ArrowSchema *schema, struct ArrowArray *values,
    int64_t offset, int64_t count, uint64_t level, void *resource) {
  ERL_NIF_TERM error{};
  if (schema->n_children > 0 && schema->children == nullptr) {
  ...
  for (int64_t child_i = offset; child_i < offset + count; child_i++) {
    ...
    ERL_NIF_TERM field_metadata;
    if (arrow_array_to_nif_term(env, field_schema, field_array, child_i, 1,
                                level + 1, field_values, field_type,
                                field_metadata, error, false, resource) == 1) {
      return error;
    }
...
ERL_NIF_TERM get_arrow_array_sparse_union_children(ErlNifEnv *env,
                                                   struct ArrowSchema *schema,
                                                   struct ArrowArray *values,
                                                   uint64_t level,
                                                   void *resource) {
  return get_arrow_array_sparse_union_children(env, schema, values, 0, -1,
                                               level, resource);
}

ERL_NIF_TERM get_arrow_run_end_encoded(ErlNifEnv *env,
                                       struct ArrowSchema *schema,
                                       struct ArrowArray *values,
                                       int64_t offset, int64_t count,
                                       uint64_t level, void *resource) {
  ...
  for (int64_t child_i = 0; child_i < 2; child_i++) {
    ...
    ERL_NIF_TERM child_type;
    ERL_NIF_TERM child_metadata;
    if (arrow_array_to_nif_term(env, schema->children[child_i],
                                values->children[child_i], 0, -1, level + 1,
                                childrens, child_type, child_metadata, error,
                                false, resource) == 1) {
      return 1;
    }
...
// Slice a validity bitmap at the given element offset, returning
// {validity_term, bit_offset}. The bitmap is sliced to start at byte offset/8,
// with bit_offset = offset%8. Returns nil if the bitmap is null or null_count
// is 0 (all values valid).
static void slice_validity_bitmap(ErlNifEnv *env, const uint8_t *bitmap,
                                  int64_t offset, int64_t count,
                                  int64_t null_count, void *resource,
                                  ERL_NIF_TERM &validity_out,
                                  int &bit_offset_out) {
  ...
  if (bitmap == nullptr || null_count == 0) {
    ...
    validity_out = enif_make_resource_binary(
        env, resource, bitmap + bitmap_start, total_bitmap_bytes);
  }
}

ERL_NIF_TERM get_arrow_array_list_children(ErlNifEnv *env,
                                           struct ArrowSchema *schema,
                                           struct ArrowArray *values,
                                           int64_t offset, int64_t count,
                                           uint64_t level, ArrowType list_type,
                                           unsigned n_items, void *resource) {
  ERL_NIF_TERM error{};
  if (schema->children == nullptr) {
    return encode_error(
  ...
  // Get child column data via arrow_array_to_nif_term (returns buffer tuples,
  // lists, etc.)
  std::vector<ERL_NIF_TERM> childrens;
  ERL_NIF_TERM children_type;
  ERL_NIF_TERM children_metadata;
  if (arrow_array_to_nif_term(env, items_schema, items_values, 0, -1, level + 1,
                              childrens, children_type, children_metadata,
                              error, false, resource) == 1) {
    return error;
  }
  ...
  int bit_offset;
  slice_validity_bitmap(env, bitmap_buffer, offset, count, values->null_count,
...
ERL_NIF_TERM get_arrow_array_list_children(ErlNifEnv *env,
  ...
  return get_arrow_array_list_children(env, schema, values, 0, -1, level,
                                       list_type, n_items, resource);
}

ERL_NIF_TERM get_arrow_array_list_view(ErlNifEnv *env,
                                       struct ArrowSchema *schema,
                                       struct ArrowArray *values,
                                       int64_t offset, int64_t count,
                                       uint64_t level, ArrowType list_type,
  ...
  ERL_NIF_TERM children_type;
  ERL_NIF_TERM children_metadata;
  // according to the Arrow spec, the bitmap buffer is not required for the
  // child values and this `buffer[0]` could be a random memory address, so we
  // simply set it to nullptr here
  items_values->buffers[0] = nullptr;
  if (arrow_array_to_nif_term(env, items_schema, items_values, 0, -1, level + 1,
                              childrens, children_type, children_metadata,
                              error, false, resource)) {
    return error;
  }
  ...
  int bit_offset_int;
  slice_validity_bitmap(env, bitmap_buffer, offset, count, values->null_count,
                        resource, validity_term, bit_offset_int);

  // Offsets and sizes as raw binaries
  if (list_type == NANOARROW_TYPE_LIST) {
    const int32_t *off32 = (const int32_t *)offsets_ptr;
    const int32_t *sz32 = (const int32_t *)sizes_ptr;
    offsets_term = enif_make_resource_binary(env, resource, &off32[offset],
                                             count * sizeof(int32_t));
    sizes_term = enif_make_resource_binary(env, resource, &sz32[offset],
                                           count * sizeof(int32_t));
  } else {
    const int64_t *off64 = (const int64_t *)offsets_ptr;
    const int64_t *sz64 = (const int64_t *)sizes_ptr;
    offsets_term = enif_make_resource_binary(env, resource, &off64[offset],
                                             count * sizeof(int64_t));
    sizes_term = enif_make_resource_binary(env, resource, &sz64[offset],
                                           count * sizeof(int64_t));
  }
...
// Build an %Adbc.BinaryData{} struct for variable-size elements
// (strings/binaries).
template <typename OffsetT>
ERL_NIF_TERM make_binary_data(ErlNifEnv *env, struct ArrowArray *values,
                              int64_t offset, int64_t count,
                              int64_t offset_buffer_index,
                              int64_t data_buffer_index,
                              int64_t bitmap_buffer_index, void *resource) {
  const OffsetT *offsets_ptr =
      (const OffsetT *)values->buffers[offset_buffer_index];
  const uint8_t *data_ptr = (const uint8_t *)values->buffers[data_buffer_index];
  const uint8_t *validity_bitmap =
      (const uint8_t *)values->buffers[bitmap_buffer_index];

  ERL_NIF_TERM offsets_term = enif_make_resource_binary(
      env, resource, &offsets_ptr[offset], (count + 1) * sizeof(OffsetT));

  OffsetT data_start = offsets_ptr[offset];
  OffsetT data_end = offsets_ptr[offset + count];
  ERL_NIF_TERM data_term = enif_make_resource_binary(
      env, resource, data_ptr + data_start, data_end - data_start);

  ERL_NIF_TERM validity_term;
  int bit_offset;
  slice_validity_bitmap(env, validity_bitmap, offset, count, values->null_count,
                        resource, validity_term, bit_offset);
  ...
  enif_make_map_from_arrays(env, keys.data(), vals.data(),
                            (unsigned)vals.size(), &binary_data);
  return binary_data;
}

// Build an %Adbc.BufferData{} struct for fixed-size elements.
ERL_NIF_TERM make_buffer_data(ErlNifEnv *env, struct ArrowArray *values,
                              int64_t offset, int64_t count,
                              size_t element_bytes, int64_t data_buffer_index,
                              int64_t bitmap_buffer_index, void *resource) {
  ...
  ERL_NIF_TERM data_binary =
      enif_make_resource_binary(env, resource, data_ptr, data_size);
  ...
  enif_make_map_from_arrays(env, keys.data(), vals.data(),
                            (unsigned)vals.size(), &buffer_data);
  return buffer_data;
}

int arrow_array_to_nif_term(ErlNifEnv *env, struct ArrowSchema *schema,
                            struct ArrowArray *values, int64_t offset,
                            int64_t count, int64_t level,
                            std::vector<ERL_NIF_TERM> &out_terms,
  ...
  NANOARROW_RETURN_NOT_OK(
      arrow_metadata_to_nif_term(env, schema->metadata, &arrow_metadata));
  ...
  if (format_len == 1) {
    ...
    if (element_bytes > 0) {
      ...
      current_term =
          make_buffer_data(env, values, offset, count, element_bytes,
      ...
      current_term =
          make_buffer_data(env, values, offset, count, sizeof(uint16_t),
                           data_buffer_index, bitmap_buffer_index, resource);
    } else if (format[0] == 'f') {
      ...
      current_term =
          make_buffer_data(env, values, offset, count, sizeof(float),
                           data_buffer_index, bitmap_buffer_index, resource);
    } else if (format[0] == 'g') {
      ...
      current_term =
          make_buffer_data(env, values, offset, count, sizeof(double),
                           data_buffer_index, bitmap_buffer_index, resource);
    } else if (format[0] == 'b') {
      // NANOARROW_TYPE_BOOL
      ...
      }
      {
        ...
        ERL_NIF_TERM data_term = enif_make_resource_binary(
            env, resource, data_buf, total_data_bytes);
        ...
        slice_validity_bitmap(env, validity_bitmap, offset, count,
                              values->null_count, resource, validity_term,
                              bit_offset_val);
        ...
        enif_make_map_from_arrays(env, keys.data(), vals.data(),
                                  (unsigned)vals.size(), &current_term);
      }
      ...
      current_term = make_binary_data<int32_t>(
          env, values, offset, count, offset_buffer_index, data_buffer_index,
          bitmap_buffer_index, resource);
    } else if (format[0] == 'U' || format[0] == 'Z') {
      ...
      current_term = make_binary_data<int64_t>(
          env, values, offset, count, offset_buffer_index, data_buffer_index,
          bitmap_buffer_index, resource);
    } else {
    ...
    if (strncmp("+s", format, 2) == 0) {
      ...
      if (count > values->length)
        count = values->length - offset;
      if (get_arrow_struct(env, schema, values, offset, count, level, children,
                           error, resource) == 1) {
        return 1;
      }
      ...
      slice_validity_bitmap(env, struct_bitmap, offset, count,
                            values->null_count, resource, struct_validity_term,
                            struct_bit_offset);

      ERL_NIF_TERM values_list = enif_make_list_from_array(
      ...
      current_term = string_views_from_buffer(
          env, offset, count,
          (const uint8_t *)values->buffers[bitmap_buffer_index],
          (const uint8_t *)values->buffers[1], n_data_buffers,
    ...
    if (format[0] == 't') {
      ...
      if (format_len == 3) {
        if (format[1] == 'd') {
          ...
          if (unit == 'D' || unit == 'm') {
            ...
            current_term = make_buffer_data(env, values, offset, count,
                                            element_bytes, data_buffer_index,
                                            bitmap_buffer_index, resource);
          } else {
            format_processed = false;
          }
          ...
          if (format_processed) {
            ...
            current_term = make_buffer_data(env, values, offset, count, 8,
                                            data_buffer_index,
                                            bitmap_buffer_index, resource);
          }
        } else if (format[1] == 'i') {
        ...
        if (format_processed) {
          ...
          current_term =
              make_buffer_data(env, values, offset, count, 8, data_buffer_index,
                               bitmap_buffer_index, resource);
        }
      } else {
        format_processed = false;
      ...
      if (format_len == 3 && strncmp("+vl", format, 3) == 0) {
        ...
        current_term =
            make_buffer_data(env, values, offset, count, nbytes,
                             data_buffer_index, bitmap_buffer_index, resource);
...
int arrow_array_to_nif_term(ErlNifEnv *env, struct ArrowSchema *schema,
                            struct ArrowArray *values, uint64_t level,
                            std::vector<ERL_NIF_TERM> &out_terms,
                            ERL_NIF_TERM &out_type, ERL_NIF_TERM &metadata,
                            ERL_NIF_TERM &error, bool skip_dictionary_check,
                            void *resource) {
  return arrow_array_to_nif_term(env, schema, values, 0, -1, level, out_terms,
                                 out_type, metadata, error,
                                 skip_dictionary_check, resource);
}
